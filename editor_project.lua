...
return 
{
  ...
  eventFlags = {
    ...
    MOD_PALLET_CHAOS_BEAT_VICTORY_ROAD_3F_1 = true,
    MOD_PALLET_CHAOS_BEAT_VICTORY_ROAD_3F_2 = true,
    MOD_PALLET_CHAOS_BEAT_VICTORY_ROAD_3F_3 = true,
    MOD_PALLET_CHAOS_BEAT_VICTORY_ROAD_3F_4 = true,
    MOD_PALLET_CHAOS_DONE = true,
    MOD_PALLET_CHAOS_H = true,
    MOD_PALLET_CHAOS_HI = true,
    MOD_PALLET_CHAOS_HID = true,
    MOD_PALLET_CHAOS_HIDE = true,
    MOD_PALLET_CHAOS_HIDE_ = true,
    MOD_PALLET_CHAOS_HIDE_O = true,
    MOD_PALLET_CHAOS_HIDE_OB = true,
    MOD_PALLET_CHAOS_HIDE_OBJ = true,
    ...
    PALLET_TOWN = {
      onEnter = {
        steps = {
          ...
          {
                      kind = "raw",
                      note = "hide_object PALLET_TOWN PALLET_BOULDER",
                      row = {
                        "hide_object",
                        "PALLET_TOWN",
                        "PALLET_BOULDER",
    ...
    VIRIDIAN_CITY = {
      onEnter = {
        steps = {
          ...
          {
                      kind = "raw",
                      note = "hide_object ROUTE_1 ROUTE_1_BOULDER",
                      row = {
                        "hide_object",
                        "ROUTE_1",
                        "ROUTE_1_BOULDER",
  ...
  strings = {},
  talkScripts = {
    ["PALLET_TOWN/TEXT_PALLET_TOWN_OBJ4"] = {
      mapId = "PALLET_TOWN",
      steps = {},
...
door, is looking\11for you. \
 ...
 and honey, please stay out of my room.",
    ...
    _VICTORY_ROAD_1FTrainer2After = "You're strong.",
    _VICTORY_ROAD_1FTrainer2Battle = "Let's fight!",
    _VICTORY_ROAD_1FTrainer2Won = "I lost...",
    _VICTORY_ROAD_3FTrainer1After = "You're strong.",
    _VICTORY_ROAD_3FTrainer1Battle = "Let's fight!",
    _VICTORY_ROAD_3FTrainer1Won = "I lost...",
    _VICTORY_ROAD_3FTrainer2After = "You're strong.",
    _VICTORY_ROAD_3FTrainer2Battle = "Let's fight!",
    _VICTORY_ROAD_3FTrainer2Won = "I lost...",
    _VICTORY_ROAD_3FTrainer3After = "You're strong.",
    _VICTORY_ROAD_3FTrainer3Battle = "Let's fight!",
    _VICTORY_ROAD_3FTrainer3Won = "I lost...",
    _VICTORY_ROAD_3FTrainer4After = "You're strong.",
    _VICTORY_ROAD_3FTrainer4Battle = "Let's fight!",
    _VICTORY_ROAD_3FTrainer4Won = "I lost...",
  },
  text_pointers = {
    ["Pallet west"] = {
