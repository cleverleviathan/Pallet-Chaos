...
return 
{
  ...
  eventFlags = {
    ...
    MOD_MOMS_SECR = true,
    MOD_MOMS_SECRE = true,
    MOD_MOMS_SECRET = true,
    MOD_PALLET_CHAOS_BEAT_PALLET_EAST_1 = true,
    ...
    MOD_PALLET_CHAOS__ = true,
    MOD_PALLET_CHAOS__R = true,
    MOD_PALLET_CHAOS__RO = true,
    MOD_PALLET_CHAOS__ROW = true,
    MOD_PALLET_CHAOS__ROW_ = true,
    MOD_PALLET_CHAOS__ROW_4 = true,
    MOD_PALLET_EAST_TESTING_BEAT_PALLET_EAST_1 = true,
    MOD_PALLET_EAST_TESTING_BEAT_PALLET_WEST_1 = true,
  },
  fishing = {},
  font = {},
  hiddenItems = {},
  ...
  text = {
    ...
    _PALLET_EASTTrainer1Battle = "Welcome to the thunderdome! \
 \
 BITCH!",
